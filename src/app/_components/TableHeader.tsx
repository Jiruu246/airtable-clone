...
export function TableHeader({ columns, virtualColumns, totalWidth, onAddColumn, isAddingColumn }: TableHeaderProps) {
  ...
  return (
    <div
      className="sticky top-0 z-10 bg-gray-50 flex w-full"
      style={{
      ...
      >
        <div className="relative w-full flex justify-center">
          <button
            ...
            className="w-full flex h-8 items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed hover:cursor-pointer transition-colors"
          >
